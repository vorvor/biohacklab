 ...
 */
function biohack_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['biohack_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('biohack sample setting'),
  '#default_value' => theme_get_setting('biohack_example'),
